...
*p²* — với *p* = 10% thì báo động giả giảm từ 10% xuống **1%**.
...
tỉ lệ lỗi              3,57%       3,55%     -0,02đ  ✅
RSS cuối lượt          161 MB      158 MB       -2%  ✅
...
|---|---|---|
| Tầng 0 — bỏ qua | 8 commit × 0 phút | 0 phút |
| Tầng 1 — smoke | 12 commit × 3 phút | 36 phút |
| Tầng 2 — leo thang | ~2 lần/ngày × 8 phút | 16 phút |
| Xác nhận lần 2 | ~1 lần/ngày × 8 phút | 8 phút |
| Tầng 3 — chạy đêm | 1 × 45 phút | 45 phút |
...
| **Xác nhận bằng lần chạy thứ hai** | Cao — từ *p* xuống *p²* | +8 phút mỗi lần nghi ngờ |
